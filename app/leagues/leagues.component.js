...
var LeaguesComponent = (function () {
    function LeaguesComponent(contactService, userService) {
    ...
    LeaguesComponent.prototype.next = function () {
    ...
    LeaguesComponent.prototype.onSubmit = function () {
        // POST-DEMO TODO: do something like save it
        this.displayMessage('Saved ' + this.contact.name);
    };
    LeaguesComponent.prototype.newContact = function () {
        this.displayMessage('New contact');
        this.contact = { id: 42, name: '' };
        this.contacts.push(this.contact);
    };
    /** Display a message briefly, then remove it. */
    LeaguesComponent.prototype.displayMessage = function (msg) {
        var _this = this;
        this.msg = msg;
